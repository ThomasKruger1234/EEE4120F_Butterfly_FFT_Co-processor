...
//                   B' = A - (W * B)
//
//               All operands and results are 32-bit signed Q10.22 fixed-point
...
module ButterflyDatapath (
    ...
    input  signed [31:0] a_imag,

    // -------------------------------------------------------------------------
    // Operand B (complex) — Q10.22 signed
    // -------------------------------------------------------------------------
    input  signed [31:0] b_real,
    input  signed [31:0] b_imag,

    // -------------------------------------------------------------------------
    // Twiddle factor W (complex) — Q10.22 signed.
    // -------------------------------------------------------------------------
    input  signed [31:0] w_real,
    input  signed [31:0] w_imag,

    // -------------------------------------------------------------------------
    // Butterfly outputs (complex) — Q10.22 signed.
    //   A_real, A_imag = A + (W * B)
    //   B_real, B_imag = A - (W * B)
    // -------------------------------------------------------------------------
    output signed [31:0] A_real,
    output signed [31:0] A_imag,
    output signed [31:0] B_real,
    output signed [31:0] B_imag
);
    ...
    // --- Layer 1: partial products of W * B ----------------------------------
    wire signed [31:0] wb_pp1;          // w_real * b_real
    wire signed [31:0] wb_pp2;          // w_imag * b_imag
    wire signed [31:0] wb_pp3;          // w_real * b_imag
    wire signed [31:0] wb_pp4;          // w_imag * b_real
    ...
    // =========================================================================
    // LAYER 1 — FOUR Q10.22 MULTIPLIERS
