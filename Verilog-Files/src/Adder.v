// =========================================================================
// Butterfly FFT Co-processor — Building Block: Q1.15 Signed Adder
// =========================================================================
//
// GROUP NUMBER: 8
//
...
// File        : Adder.v
// Description : 16-bit signed adder for Q1.15 fixed-point operands.
...
//               a safe range so the sum stays inside Q1.15. The expected
